# Conversation QA and Compliance Scorecard (E3) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    CONVQA_PROFILE=gcp \
    CONVQA_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "exec uvicorn conversation_qa_scorecard.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
