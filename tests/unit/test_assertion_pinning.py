...
from conversation_qa_scorecard.adapters.gcp.identity import IapIdentityAdapter
...
def _adapter_module() -> object:
    ...
    return importlib.import_module("conversation_qa_scorecard.adapters.gcp.identity")
