...
read
    ...
    bind_profile == local AND profile chosen AND CONVQA_S2S_TOKEN unset
...
approver's groups and tenant, and ``/v1/scorecards`` with a real scorecard written to the
review outbox.
...
from conversation_qa_scorecard.adapters.local.identity import (
    LocalIdentityAdapter,
)
from conversation_qa_scorecard.adapters.onprem.identity import (
