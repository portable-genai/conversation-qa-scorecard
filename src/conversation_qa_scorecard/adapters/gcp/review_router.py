...
distinct from this service's own inbound ``CONVQA_S2S_TOKEN``.
...
from .._review_payload import scorecard_to_review

_SERVICE_ACTOR = "conversation-qa-scorecard"
...
class CloudReviewRouter:
    ...
    def route(self, scorecard: Scorecard, *, maker: str, tenant: str = "") -> str:
        ...
        review = scorecard_to_review(scorecard, maker=maker, tenant=tenant or self._settings.tenant)
